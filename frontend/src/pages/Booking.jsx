...
const Booking = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        weight: 150,
        packingTier: 'premium', // standard, premium, crate
        insuranceCover: 'full', // basic, full
        elevatorPickup: true,
    ...
    // Real-world Geoapify & OpenStreetMap OSRM distance calculation engine
    useEffect(() => {
        ...
        const timer = setTimeout(async () => {
            ...
            try {
                ...
                // 1. Geoapify Routing API if API key is provided
                if (geoKey) {
                ...
                // 2. OpenStreetMap Nominatim + OSRM Routing Engine (Free)
            ...
            // 3. Known matrix & string telemetry fallback
            if (!isMounted) return;
